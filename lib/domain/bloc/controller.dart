...
import 'package:video_editor_plus/domain/entities/cover_data.dart';
import 'package:video_editor_plus/domain/entities/cover_style.dart';
import 'package:video_editor_plus/domain/entities/crop_style.dart';
import 'package:video_editor_plus/domain/entities/ffmpeg_config.dart';
...
class VideoEditorController extends ChangeNotifier {
  ...
  VideoFFmpegConfig createVideoFFmpegConfig() {
    return VideoFFmpegConfig(trimCommand: _trimCmd, crop: _getCrop(), rotation: _getRotation());
  }

  CoverFFmpegConfig createCoverFFmpegConfig() {
    return CoverFFmpegConfig(crop: _getCrop(), rotation: _getRotation());
  }
}
