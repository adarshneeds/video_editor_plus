...
abstract class FFmpegConfig {
  ...
  String getExportFilters({VideoExportFormat? videoFormat, double scale = 1.0, bool isFiltersEnabled = true}) {
...
class VideoFFmpegConfig extends FFmpegConfig {
  const VideoFFmpegConfig({required this.trimCommand, required super.crop, required super.rotation});
  ...
  String createExportCommand({
    ...
    final filter = getExportFilters(videoFormat: outputFormat, scale: scale, isFiltersEnabled: isFiltersEnabled);
...
class CoverFFmpegConfig extends FFmpegConfig {
  ...
  String createExportCommand({
    ...
    final filter = getExportFilters(scale: scale, isFiltersEnabled: isFiltersEnabled);
