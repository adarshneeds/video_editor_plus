...
import 'package:video_editor_plus/controllers/controller.dart';
...
Rect resizeCropToRatio(Size layout, Rect crop, double r) {
  ...
  if (r < crop.size.aspectRatio) {
    ...
    final rect = Rect.fromCenter(center: crop.center, width: size.width, height: size.height);
  ...
  final rect = Rect.fromCenter(center: crop.center, width: newCenteredCrop.width, height: newCenteredCrop.height);
...
Rect calculateCroppedRect(VideoEditorController controller, Size layout, {Offset? min, Offset? max}) {
