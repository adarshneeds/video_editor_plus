...
class _CoverSelectionState extends State<CoverSelection> with AutomaticKeepAliveClientMixin {
  ...
  Stream<List<CoverData>> _generateCoverThumbnails() =>
      generateCoverThumbnails(widget.controller, quantity: widget.quantity, quality: widget.quality);
        ...
        return snapshot.hasData
            ...
            : Center(
                child: SizedBox(
                  height: 32,
                  width: 32,
                  child: CircularProgressIndicator(strokeWidth: 2, color: widget.loadingIndicatorColor),
                ),
              );
      },
    );
